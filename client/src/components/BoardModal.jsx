    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/40 p-4 backdrop-blur-sm animate-fade-in">
      <div className="relative w-full max-w-md rounded-2xl border border-slate-100 bg-white p-8 shadow-2xl">
        ...
        <div className="mb-6">
          ...
          <p className="mt-1 text-xs text-slate-400">Establish a new track for task cards and AI analysis.</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-5">
          <label className="block">
            <span className="mb-2 block text-xs font-bold uppercase tracking-wider text-slate-500">Board Name</span>
            <input 
              name="name" 
              value={form.name} 
          ...
          <div>
            <span className="mb-2.5 block text-xs font-bold uppercase tracking-wider text-slate-500">Track Theme Color</span>
