    ...
    <section className="w-full border-editorial bg-white p-6 shadow-editorial rounded-3xl relative overflow-hidden font-sans">
      ...
      <div className="flex items-center justify-between border-b border-brand-black/10 pb-5">
        <div>
          ...
          <p className="text-[10px] font-sans-editorial font-bold text-brand-black/45 mt-1">Real-time collaboration stream.</p>
        </div>
      </div>
      ...
      {onLoadMore && (
        <div className="mt-6 flex justify-start">
          <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
            ...
            >
              {loadingMore ? <RefreshCw className="h-3.5 w-3.5 animate-spin text-brand-yellow" /> : null}
