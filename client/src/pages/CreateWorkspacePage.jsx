    ...
    <div className="relative min-h-screen bg-brand-offwhite px-6 py-12 text-brand-black md:py-20 overflow-hidden dot-grid flex items-center justify-center font-sans">
      <div className="mx-auto grid max-w-5xl gap-8 lg:grid-cols-[1.1fr_0.9fr] items-start animate-fade-in w-full">
        ...
        <form
          ...
          className="border-editorial bg-white p-6 sm:p-8 shadow-editorial rounded-3xl relative overflow-hidden flex flex-col animate-fade-in"
        >
          ...
          <div className="mb-8">
            ...
            <h1 className="font-editorial text-2xl sm:text-3xl font-black text-brand-black uppercase leading-none mt-1">
              Create workspace
            </h1>
              ...
              <div className="flex items-start gap-4">
                ...
                >
                  {emojiMap[preview.logo] ? (
                    React.createElement(emojiMap[preview.logo], {
                ...
                <div className="min-w-0 flex-1">
                  <h3 className="truncate font-editorial text-lg font-bold text-brand-black leading-none uppercase tracking-wide">
                    {preview.name}
                  </h3>
                  <p className="mt-2 text-[9px] font-black text-brand-purple uppercase tracking-widest flex items-center gap-1.5 font-sans-editorial">
                    <Workflow className="h-3.5 w-3.5 text-brand-purple animate-pulse" /> active
                    space
                  </p>
                  <p className="mt-4 text-xs leading-relaxed text-brand-black/50 font-sans-editorial font-bold break-words">
                    {preview.description}
                  </p>
                </div>
              </div>
